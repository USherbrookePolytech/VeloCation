...
public class LouerView extends AbstractView
{
    ...
    private void initLouer()
    {
        ...
        gl_LouerPanel.setHorizontalGroup(gl_LouerPanel.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_LouerPanel
                        .createSequentialGroup().addGap(23).addGroup(gl_LouerPanel
                                .createParallelGroup(Alignment.LEADING)
                                .addGroup(gl_LouerPanel.createSequentialGroup()
                                        .addComponent(LouerLblNombreDeVlo).addPreferredGap(
                                                ComponentPlacement.RELATED)
                                        .addComponent(LouerSpinnerVelo, GroupLayout.PREFERRED_SIZE, 40,
                                ...
                                .addGroup(gl_LouerPanel.createParallelGroup(Alignment.TRAILING, false)
                                        .addGroup(gl_LouerPanel.createSequentialGroup()
                                                ...
                                                .addComponent(btnAide, GroupLayout.PREFERRED_SIZE, 65,
                                                        GroupLayout.PREFERRED_SIZE))
                                        .addComponent(lblPourVlo, Alignment.LEADING).addComponent(scrollPane,
                                                Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 417,
                                                GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap(17, Short.MAX_VALUE))
                .addGroup(Alignment.TRAILING,
                        gl_LouerPanel.createSequentialGroup().addContainerGap(273, Short.MAX_VALUE)
        ...
        gl_LouerPanel.setVerticalGroup(gl_LouerPanel.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_LouerPanel.createSequentialGroup()
                        ...
                        .addPreferredGap(ComponentPlacement.RELATED, 21, Short.MAX_VALUE).addComponent(lblPourVlo)
